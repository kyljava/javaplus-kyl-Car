      ...
      <div class="row align-items-top">
        <div class="col-lg-6">
          ...
          <div class="card mb-3">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="<%=request.getContextPath() %>/assets/img/card.jpg" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col-lg-3">
          ...
          <div class="card">
            <img src="<%=request.getContextPath() %>/assets/img/card.jpg" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            ...
            <img src="<%=request.getContextPath() %>/assets/img/card.jpg" class="card-img-bottom" alt="...">

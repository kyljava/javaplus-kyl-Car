...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<%=request.getContextPath()%>/jsp/login/userlogin.jsp">
              ...
              <div class="card top-selling">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath() %>/assets/img/product-1.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath() %>/assets/img/product-2.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath() %>/assets/img/product-3.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath() %>/assets/img/product-4.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="<%=request.getContextPath() %>/assets/img/product-5.jpg" alt=""></a></th>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              ...
              <div class="news">
                ...
                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath() %>/assets/img/news-4.jpg" alt="">
                  <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                  <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="<%=request.getContextPath() %>/assets/img/news-5.jpg" alt="">
